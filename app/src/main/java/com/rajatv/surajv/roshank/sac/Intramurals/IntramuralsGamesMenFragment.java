...
public class IntramuralsGamesMenFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        gameDB=FirebaseDatabase.getInstance().getReference().child(StringVariable.INTRAMURALS).child(StringVariable.MEN);
