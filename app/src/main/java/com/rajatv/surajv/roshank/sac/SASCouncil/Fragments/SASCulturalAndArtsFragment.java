...
public class SASCulturalAndArtsFragment extends Fragment {
    ...
    ArrayList<String> cultural = new ArrayList<>();
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    db2.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            try{
                            if (sas.split("@SAC2.0@")[0].equals("Cultural & Arts")) {
                                int value = 4;
...
//                                        if (String.valueOf(postSnapshot.child("Category").getValue()).equalsIgnoreCase("Cultural & Arts"))
//
