...
public class SASDesigningFragment extends Fragment {
    ...
    ArrayList<String> designing = new ArrayList<>();
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    db2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            try{
                            if (sas.split("@SAC2.0@")[0].equalsIgnoreCase("Designing & Social Media")) {
                                int value = 4;
...
//                    Log.e("userid", "" + String.valueOf(postSnapshot.child("UserUID").getValue()));
//                    try {
//                        contactsSubDatabase.addValueEventListener(new ValueEventListener() {
//
//                            @Override
//                            public void onDataChange(@NonNull DataSnapshot dataSnapshot1) {
//                                Log.e("Count2", "" + dataSnapshot1.getChildrenCount());
//                                for (DataSnapshot post1Snapshot : dataSnapshot1.getChildren()) {
//                                    if (String.valueOf(postSnapshot.child("Category").getValue()).equalsIgnoreCase("Designing & Social Media"))
