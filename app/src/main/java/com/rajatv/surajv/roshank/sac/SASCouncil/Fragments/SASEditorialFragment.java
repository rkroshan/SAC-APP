...
public class SASEditorialFragment extends Fragment {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    db2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            try {
                                if (sas.split("@SAC2.0@")[0].equals("Editor")) {
                                    int value = 4;
...
//                                    if (String.valueOf(postSnapshot.child("Category").getValue()).equalsIgnoreCase("Editorial"))
//
