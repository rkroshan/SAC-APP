...
public class FunEventRecyclerViewAdapter extends RecyclerView.Adapter<FunEventRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    public FunEventRecyclerViewAdapter(Context context, List<SubeventDetails1> subeventDetailsList) {
    ...
    public FunEventRecyclerViewAdapter() {
    }

    @NonNull
    @Override
    public FunEventRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.element_details_subevents, viewGroup, false);
        FunEventRecyclerViewAdapter.ViewHolder holder = new FunEventRecyclerViewAdapter.ViewHolder(view);
//        Log.e("final1", "reach");
    ...
    @Override
    public void onBindViewHolder(@NonNull FunEventRecyclerViewAdapter.ViewHolder viewHolder, int i) {
...
//        viewHolder.location.setText(subEventList.get(i).getCurrentplace());
        ...
        viewHolder.ic_addition.setVisibility(View.GONE);
        viewHolder.register_yourself.setVisibility(View.GONE);
...
//        userUID = mainMap.get(StringVariable.USER_USER_UID).toString();
        ...
        viewHolder.register_view.setVisibility(View.GONE);
