...
public class TomorrowAdapter extends  RecyclerView.Adapter<TomorrowAdapter.ViewHolder> {
    ...
    Context context;
    public List<TodayTomorrowModalClass> tomorrowEventList;

    public TomorrowAdapter() {
    }

    public TomorrowAdapter(Context context, List<TodayTomorrowModalClass> tomorrowEventList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder todayTomorrowViewHolder, int i) {
        ...
        TodayTomorrowModalClass todayTomorrowModalClass = tomorrowEventList.get(i);
