...
import com.rajatv.surajv.roshank.sac.tcf2019.CulturalEventsFragments.CulturalEventsRecyclerViewAdapter;

import java.util.ArrayList;
import java.util.List;

public class TechnicalEventsFrag extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        eventdatabase2=FirebaseDatabase.getInstance().getReference().child("events").child("technical-events").child("children");
        Log.d("hello","dataSnapshot");
        eventsDatabase = FirebaseDatabase.getInstance().getReference().child("events");  //ADD THE DATABASE REFERENCE
try {
